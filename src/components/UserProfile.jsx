    ...
    <div className='nav-item right-1 top-16 absolute bg-white dark:bg-[#42464D] p-8 rounded-lg md:w-96'>
        ...
        <div className="flex gap-5 items-center mt-6 border-color border-b-1 pb-6">
            ...
            <div>
                ...
                <p className="text-gray-500 text-sm font-semibold dark:text-gray-400">info@todoo.com</p>
            </div>
        </div>
        <div>
            {userProfileData.map((item, index) => 
            <div key={index} className='flex gap-5 boredr-b-1 border-color p-4 hover:bg-light-gray cursor-pointer dark:hover:bg-[#42464D'>
                <button
                type='button'
